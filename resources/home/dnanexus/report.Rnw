...
\fancyhf{}
\lhead{WGS Performance Report (v\texttt{\Sexpr{params$version$script}}): \texttt{\Sexpr{texquote(report$sampleid)}}}
\rhead{Page \thepage\ of \pageref{LastPage}}

\let\endtitlepage\relax
\begin{titlepage}
\begin{flushleft}
\LARGE{WGS Performance Report: \texttt{\Sexpr{texquote(report$sampleid)}}}
\HRule
\end{flushleft}
\end{titlepage}

\section{Summary}
Sample ID: \texttt{\Sexpr{texquote(report$sampleid)}} \\
...
\item Data: \begin{itemize}
	...
	\item Sample ID: \texttt{\Sexpr{texquote(report$sampleid)}}
