...
\fancyhf{}
\lhead{WGS Performance Report (v\texttt{\Sexpr{param$version$script}}): \texttt{\Sexpr{texquote(calls.sampleid)}}}
\rhead{Page \thepage\ of \pageref{LastPage}}

\let\endtitlepage\relax
\begin{titlepage}
\begin{flushleft}
\LARGE{WGS Performance Report: \texttt{\Sexpr{texquote(calls.sampleid)}}}
\HRule
\end{flushleft}
\end{titlepage}
...
plotROC(perf.snv$zyg[[report$specifications$measure]][c("RRvsAA", "RRvsRA")]) + 
	...
	geom_point(aes(colour = Zygosity, shape = Score), size = 4, data = data.frame(
		FP = c(1 - snv.het.perf$spec, 1 - snv.hom.perf$spec, 1 - snv.het.perf$spec, 1 - snv.hom.perf$spec),
		TP = c(snv.het.perf$sens, snv.hom.perf$sens, snv.het.perf$sens, snv.hom.perf$sens),
...
plotROC(perf.indelsubst$zyg[[report$specifications$measure]][c("RRvsAA", "RRvsRA")], type.fp = "count") + 
	...
	ylim(0, 1) + 
	geom_point(aes(colour = Zygosity, shape = Score), size = 4, data = data.frame(
		FP = c(indelsubst.het.perf$nfp, indelsubst.hom.perf$nfp, indelsubst.het.perf$nfp, indelsubst.hom.perf$nfp),
		TP = c(indelsubst.het.perf$sens, indelsubst.hom.perf$sens, indelsubst.het.perf$sens, indelsubst.hom.perf$sens),
		Zygosity = c("RRvsRA", "RRvsAA", "RRvsRA", "RRvsAA"),
		Score = c(report$specifications$label, report$specifications$label, "FILTER = PASS", "FILTER = PASS"))) + 
	scale_shape_manual(name = "Score", breaks = c(report$specifications$label, "FILTER = PASS"), values = c(5, 16)) + 
	guides(size = FALSE) + 
...
plotROC(perf.snv.coding10$zyg[[report$specifications$measure]][c("RRvsAA", "RRvsRA")]) + 
	...
	coord_cartesian(xlim = c(-1e-7, 1e-5)) + ylim(0, 1) + 
	geom_point(aes(colour = Zygosity, shape = Score), size = 4, data = data.frame(
		FP = c(1 - snv.coding10.het.perf$spec, 1 - snv.coding10.hom.perf$spec, 1 - snv.coding10.het.perf$spec, 1 - snv.coding10.hom.perf$spec),
		TP = c(snv.coding10.het.perf$sens, snv.coding10.hom.perf$sens, snv.coding10.het.perf$sens, snv.coding10.hom.perf$sens),
		Zygosity = c("RRvsRA", "RRvsAA", "RRvsRA", "RRvsAA"),
		Score = c(report$specifications$label, report$specifications$label, "FILTER = PASS", "FILTER = PASS"))) + 
	scale_shape_manual(name = "Score", breaks = c(report$specifications$label, "FILTER = PASS"), values = c(5, 16)) + 
	guides(size = FALSE) + 
...
plotROC(perf.indelsubst.coding10$zyg[[report$specifications$measure]][c("RRvsAA", "RRvsRA")], type.fp = "count") + 
	...
	ylim(0, 1) + 
	geom_point(aes(colour = Zygosity, shape = Score), size = 4, data = data.frame(
		FP = c(indelsubst.coding10.het.perf$nfp, indelsubst.coding10.hom.perf$nfp, indelsubst.coding10.het.perf$nfp, indelsubst.coding10.hom.perf$nfp),
		TP = c(indelsubst.coding10.het.perf$sens, indelsubst.coding10.hom.perf$sens, indelsubst.coding10.het.perf$sens, indelsubst.coding10.hom.perf$sens),
		Zygosity = c("RRvsRA", "RRvsAA", "RRvsRA", "RRvsAA"),
		Score = c(report$specifications$label, report$specifications$label, "FILTER = PASS", "FILTER = PASS"))) + 
	scale_shape_manual(name = "Score", breaks = c(report$specifications$label, "FILTER = PASS"), values = c(5, 16)) + 
	guides(size = FALSE) + 
