...
<<summary-plots, out.width='.45\\linewidth', out.height='.37\\linewidth', fig.show='hold'>>=
plotROC(perf.snv$zyg[[report$specifications$measure]][c("RRvsAA", "RRvsRA")]) + 
	ggtitle("SNV: All GiaB") + 
...
count.table = xtable(data.frame(
	"Region" = c("GiaB HC", "", "", "", "Coding GiaB HC", "", "", ""),
	"Zygosity" = c("Het", "", "Hom", "", "Het", "", "Hom", ""),
	"Mutation" = c("SNV", "Indel", "SNV", "Indel", "SNV", "Indel", "SNV", "Indel"),
	"TP" = c(
		snv.het.perf$ntp,
		indelsubst.het.perf$ntp,
		snv.hom.perf$ntp,
		indelsubst.hom.perf$ntp,
		snv.coding10.het.perf$ntp,
		indelsubst.coding10.het.perf$ntp,
		snv.coding10.hom.perf$ntp,
		indelsubst.coding10.hom.perf$ntp),
	"FP" = c(
		snv.het.perf$nfp,
		indelsubst.het.perf$nfp,
		snv.hom.perf$nfp,
		indelsubst.hom.perf$nfp,
		snv.coding10.het.perf$nfp,
		indelsubst.coding10.het.perf$nfp,
		snv.coding10.hom.perf$nfp,
		indelsubst.coding10.hom.perf$nfp),
	"TN" = c(
		snv.het.perf$ntn,
		NA,
		snv.hom.perf$ntn,
		NA,
		snv.coding10.het.perf$ntn,
		NA,
		snv.coding10.hom.perf$ntn,
		NA),
	"FN" = c(
		snv.het.perf$nfn,
		indelsubst.het.perf$nfn,
		snv.hom.perf$nfn,
		indelsubst.hom.perf$nfn,
		snv.coding10.het.perf$nfn,
		indelsubst.coding10.het.perf$nfn,
		snv.coding10.hom.perf$nfn,
		indelsubst.coding10.hom.perf$nfn)),
	digits = 0)
