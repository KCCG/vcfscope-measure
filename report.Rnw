...
% SCORE AND THRESHOLD DIAGNOSTIC ROCS
%--------------------------------------------------------------------
\clearpage
...
# plotROC(perf.snv$functional) + coord_cartesian(xlim = c(0, 2.5e-6), ylim = c(0.8, 1)) + theme_bw() + labs(colour = "Score", linetype = "Sequence function") + scale_colour_brewer(palette = "Set1")

# plotROC(perf.snv$goldcall) + coord_cartesian(xlim = c(0, 2.5e-6), ylim = c(0.8, 1)) + theme_bw() + labs(colour = "Score", linetype = "GiaB region") + scale_colour_brewer(palette = "Set1")
@
...
# plotROC(perf.indelsubst$functional, type.fp = "count", facet = 2)  + theme_bw() + labs(colour = "Score", linetype = "Sequence function") + scale_colour_brewer(palette = "Set1")
# plotROC(perf.indelsubst$goldcall, type.fp = "count", facet = 2) + theme_bw() + labs(colour = "Score", linetype = "GiaB region") + scale_colour_brewer(palette = "Set1")
...
# plotROC(perf.all$functional, type.fp = "count", facet = 2) + theme_bw() + labs(colour = "Score", linetype = "Sequence function") + scale_colour_brewer(palette = "Set1")
# plotROC(perf.all$goldcall, type.fp = "count", facet = 2) + theme_bw() + labs(colour = "Score", linetype = "GiaB region") + scale_colour_brewer(palette = "Set1")
